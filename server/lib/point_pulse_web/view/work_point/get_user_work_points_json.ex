defmodule PointPulseWeb.UserWorkPoint.GetUserWorkPointJSON do
  ...
  def show_list(%{user_work_points: user_work_points}) do
    %{status: :OK, data: for(user_work_point <- user_work_points, do: data(user_work_point))}
  end
