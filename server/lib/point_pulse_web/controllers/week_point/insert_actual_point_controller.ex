defmodule PointPulseWeb.UserWeekPoint.InsertActualPointController do
  ...
  def insert_actual_point(conn, user_week_point_params) do
              ...
              true ->
                case UserWeekPoints.get_user_week_point_by_time!(
                  ...
                  user_week_point ->
                    user_week_point_params =
                      user_week_point_params
                      |> Map.put_new(:old_actual_point, 0)
                      |> Map.put_new(:plan_point, user_week_point.plan_point)
                      |> Map.put_new(:actual_point, 0)

                    if user_week_point_params.old_actual_point == user_week_point.actual_point do
                      ...
                      infor_point =
                        ...
                        |> Map.put(:new_actual_point, user_week_point_params.actual_point)
  ...
  def insert_force_actual_point(conn, user_week_point_params) do
    user_week_point_params =
      @api_param_insert_member_week_point
      |> Validator.parse(user_week_point_params)
      |> Validator.get_validated_changes!()
